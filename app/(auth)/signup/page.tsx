...
export default function SignUpPage() {
  ...
  return (
    <>
      ...
      <AuthSplitLayout
        illustration="/sign-up.svg"
        illustrationAlt="Person completing a registration form"
        tagline="Your personal health intelligence starts here"
        taglineSub="Create your free account and upload your first report in under 60 seconds."
      >
        <AuthCard
          title="Create your account"
          subtitle="Start understanding your health today"
        >
        {/* Google OAuth */}
        ...
        <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4">
          ...
          {/* Age — numerical input, no date picker */}
