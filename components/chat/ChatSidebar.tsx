...
function SearchModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <>
      ...
      <div className="fixed inset-x-4 top-24 z-50 mx-auto max-w-md rounded-2xl border shadow-2xl"
            ...
            filtered.map((h) => (
              ...
              >
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" aria-hidden="true"
                  ...
                  <path d="M2 3h10a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1H4l-2 2V4a1 1 0 0 1 1-1Z"
...
export default function ChatSidebar({
  ...
  function saveEdit(id: string) {
    if (editValue.trim()) {
      setHistory((prev) => prev.map((h) => h.id === id ? { ...h, title: editValue.trim() } : h));
    }
    setEditingId(null);
  }
  ...
  const body = (isMobileDrawer = false) => (
    ...
    >
      ...
      >
        {collapsed && !isMobileDrawer ? (
          <div className="relative flex items-center justify-center">
            ...
            <Image src="/logo.svg" alt="Simplimed" width={28} height={28}
          ...
          <>
            ...
            {!isMobileDrawer ? (
              <button onClick={onToggleCollapse}
                ...
                style={{ color: "var(--color-text-muted)" }} aria-label="Collapse sidebar"
                onMouseEnter={(e) => {
      ...
      {(!collapsed || isMobileDrawer) ? (
        <div className="flex flex-col gap-2 px-3 pt-4 pb-2">
          ...
          >
            ...
            Search chats
            <kbd className="ml-auto rounded px-1.5 py-0.5 text-[9px] font-medium"
          ...
          {history.map((item) => {
            ...
            if (collapsed && !isMobileDrawer) {
              return (
                <button
                  ...
                  style={isActive
                    ? { backgroundColor: "var(--color-brand-light)", border: "1px solid #C7D2FE" }
                    : { border: "1px solid transparent" }}
                  onMouseEnter={(e) => {
                    if (!isActive) (e.currentTarget as HTMLElement).style.backgroundColor = "var(--color-bg-overlay)";
                  }}
                  onMouseLeave={(e) => {
            ...
            return (
              <div
                ...
                style={isActive ? { backgroundColor: "var(--color-brand-light)", border: "1px solid #C7D2FE" } : { border: "1px solid transparent" }}
              >
                {/* Chat icon */}
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" className="shrink-0"
                  style={{ color: isActive ? "var(--color-brand)" : "var(--color-text-muted)" }} aria-hidden="true">
                  <path d="M2 3h10a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1H4l-2 2V4a1 1 0 0 1 1-1Z"
                    stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round" />
                </svg>
                ...
                {!isEditing && (
                  <div className={`flex shrink-0 items-center gap-0.5 ${isActive ? "opacity-100" : "opacity-0 group-hover:opacity-100"} transition-opacity duration-150`}>
                    {/* Edit */}
                    <button
                    ...
                    >
                      <svg width="12" height="12" viewBox="0 0 12 12" fill="none" aria-hidden="true">
                        <path d="M8.5 1.5L10.5 3.5 4 10H2V8L8.5 1.5Z" stroke="currentColor" strokeWidth="1.2" strokeLinejoin="round" />
                      </svg>
                    </button>
        ...
        <div className="px-3 py-2">
          <button onClick={() => { window.location.href = "/plans"; if (isMobileDrawer) onMobileClose(); }}
            ...
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
              <path d="M8 1l2 3h4l-3 3 1 4-4-2-4 2 1-4-3-3h4l2-3Z" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round" />
            </svg>
            Manage Plans
          </button>
        </div>
      ...
      <div className="relative p-3" style={{ borderTop: "1px solid var(--color-border)" }}>
        ...
        >
          ...
          <div className="flex items-center gap-3 border-b px-4 py-3"
            ...
            <div className="min-w-0 flex-1">
              <p className="truncate text-sm font-semibold" style={{ color: "var(--color-text-primary)" }}>Alex Kim</p>
              <p className="truncate text-xs" style={{ color: "var(--color-text-muted)" }}>Pro Plan</p>
            </div>
          </div>
          ...
          <div className="py-1.5">
            <button onClick={() => { setShowUserMenu(false); setShowSettings(true); }}
              ...
              <svg width="16" height="16" viewBox="0 0 18 18" fill="none" aria-hidden="true">
                ...
                <circle cx="7" cy="5" r="1.5" fill="var(--color-bg-base)" stroke="currentColor" strokeWidth="1.4" />
                <circle cx="11" cy="9" r="1.5" fill="var(--color-bg-base)" stroke="currentColor" strokeWidth="1.4" />
                <circle cx="6" cy="13" r="1.5" fill="var(--color-bg-base)" stroke="currentColor" strokeWidth="1.4" />
              </svg>
              Settings
            </button>

            <div className="mx-3 my-1 h-px" style={{ backgroundColor: "var(--color-border-muted)" }} />
            ...
            <button
              ...
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
                <path d="M6 14H3a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1h3M11 11l3-3-3-3M5 8h9" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
              Log out
            </button>
          </div>
        ...
        <div
          onClick={() => { if (!collapsed || isMobileDrawer) setShowUserMenu(!showUserMenu); }}
        ...
        >
          ...
          {(!collapsed || isMobileDrawer) && (
            <>
              <div className="min-w-0 flex-1">
                <p className="truncate text-sm font-semibold" style={{ color: "var(--color-text-primary)" }}>Alex Kim</p>
                <p className="truncate text-xs" style={{ color: "var(--color-text-muted)" }}>alex@simplimed.ai</p>
              </div>
